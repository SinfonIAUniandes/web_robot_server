...
<template>
  ...
  <div class="flex items-center justify-center w-1/2 mx-auto">
    <textarea
      class="rounded-md border border-gray-300 p-2 resize-none h-12 w-full"
      v-model="imageUrl"
      @keydown.enter.prevent="displayOnlineImage"
      placeholder="Copy here the link to the image you want to show :-)"
    ></textarea>
  </div>
  <br />
  <div class="flex items-center justify-center w-1/2 mx-auto">
  ...
  <div class="flex items-center justify-center w-1/2 mx-auto">
    <textarea
      class="rounded-md border border-gray-300 p-2 resize-none h-12 w-full"
      v-model="websiteUrl"
      @keydown.enter.prevent="sendWebsiteRequest"
      placeholder="Copy here the link to the webpage you want to show :-)"
    ></textarea>
  </div>
  <br />
  <div class="flex items-center justify-center w-1/2 mx-auto">
