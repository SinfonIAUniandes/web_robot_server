...
<template>
  <div class="flex flex-col gap-4 bg-gray-800 p-2 rounded-lg shadow-lg m-1">
    ...
    <div class="flex justify-between">
      ...
      <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-md" @click="sendRequest">
        Speak
      </button>

      <button class="bg-gray-200 hover:bg-gray-300 text-gray-700 font-medium py-2 px-4 rounded-md disabled:opacity-50" @click="sendHowAreYou">
        How are you?
      </button>
    </div>
  </div>
